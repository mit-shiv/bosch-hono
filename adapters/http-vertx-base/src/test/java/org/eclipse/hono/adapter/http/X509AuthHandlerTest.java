...
public class X509AuthHandlerTest {
    ...
    private HonoClientBasedAuthProvider authProvider;
    ...
    public void setUp() {
        ...
        authHandler = new X509AuthHandler(authProvider, tenantServiceClient);
    }
    ...
    public void testHandleFailsWithStatusCodeFromAuthProvider() throws SSLPeerUnverifiedException {
        ...
        when(tenantClient.get(any(X500Principal.class), (SpanContext) any())).thenReturn(Future.failedFuture(error));
